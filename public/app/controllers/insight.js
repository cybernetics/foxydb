steal(
	...
	'app/views/pages/insight/sidebar.ejs',
	'app/views/pages/insight/content.ejs',
	'app/views/pages/insight/tools.ejs',
	'app/views/pages/insight/structure.ejs',
	'app/views/pages/insight/selectcolumns.ejs',
	'app/views/pages/insight/selecttable.ejs',
	'app/views/pages/insight/graph.ejs',
	'app/views/pages/insight/results.ejs',
	'app/views/pages/insight/database.ejs',
		...
		can.Control(
			...
			},
			{
				...
				getStructure: function() {
					...
					self.element.find('.structure').html('app/views/pages/insight/structure.ejs', {structure: {}, insight: self.insight});
					...
					$.get('/api/databases/structure/'+self.insight.attr('database_id'), function(response) {
						...
						self.element.find('.structure').html('app/views/pages/insight/structure.ejs', {structure: res, insight: self.insight});
				...
				'.relationNew click': function (element, event) {
					...
					if (element.siblings('.innerUpdate').find('.relationCurrent:visible').length) {
					 	element.siblings('.innerUpdate').find('.relationCurrent:visible').html('app/views/pages/insight/selectcolumns.ejs', {columns: this.element.find('.' + element.parents('li').data('field').table).data('table')});
					 	element.siblings('.innerUpdate').find('.relationTable:visible').html('app/views/pages/insight/selecttable.ejs', {rels: this.insight.attr('relations'), table: element.parents('li').data('field').table});
				...
				'.relationsInner span click': function (element, event) {
					...
					form.find('.relationCurrent').html('app/views/pages/insight/selectcolumns.ejs', {columns: this.element.find('.' + elm.data('field').table).data('table'), selected: datas.field});
					form.find('.relationColumn').html('app/views/pages/insight/selectcolumns.ejs', {columns: this.element.find('.' + datas.reltable).data('table'), selected: datas.relfield});
					form.find('.relationTable').html('app/views/pages/insight/selecttable.ejs', {rels: this.insight.attr('relations'), table: datas.table, selected: datas.reltable});
				...
				'.relationTable change': function (element, event) {
					...
					if (tableClass != -1) {
						...
						this.element.find('.relationColumn:visible').html('app/views/pages/insight/selectcolumns.ejs', {columns: datas});
				...
				generateGraph: function() {
					...
					self.element.find('.displayMode.graph').html('app/views/pages/insight/graph.ejs', {type:self.insight.attr('graphopts.type'), x:self.insight.attr('graphopts.x'), y:self.insight.attr('graphopts.y'), controller: self, fields: fields, results: self.currentResults.data, count: Math.ceil(self.currentResults.found_rows/50), page: self.currentPage, insight: self.insight});
				...
				fetchData: function(element, page) {
					...
					$.ajax({
						...
						success: function(data) {
							...
							self.element.find('.displayMode.results').html('app/views/pages/insight/results.ejs', {fields: fields, results: data.data, count: Math.ceil(data.found_rows/50), page: page});
				...
				'.relTables change': function (element, event) {
					...
					element.siblings('.relColumn:visible').html('app/views/pages/insight/selectcolumns.ejs', {columns: this.element.find('.' + table).data('table')});
				},
				...
				'.databaseSelect change': function(element, event) {
					...
					if(element.val() === 'new') {
						self.element.find('.sidebar .newDatabase').html('app/views/pages/insight/database.ejs', {});
